  ...
  head: () => ({
    meta: [
      ...
      { title: "SkillHire — Hire verified local skilled workers" },
      {
        name: "description",
        content:
          "SkillHire connects you with verified electricians, plumbers, cleaners, tutors, and other trusted local professionals. Book in minutes.",
      },
      { property: "og:site_name", content: "SkillHire" },
